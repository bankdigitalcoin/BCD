...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1; // addresses start with "1";
...
const char     CRYPTONOTE_NAME[]                             = "bankdigitalcoin";
...
const int      P2P_DEFAULT_PORT                              = 48888;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 48889;
